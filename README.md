...
* [Capítulo V: Solution UI/UX Design](#capítulo-v-solution-uiux-design)
  ...
  * [5.4. Applications UX/UI Design](#54-applications-uxui-design)
    ...
    * [5.4.2. Applications Wire flow Diagrams](#542-applications-wire-flow-diagrams)
      * [Mobile Applications Wire flow Diagrams](#mobile-applications-wire-flow-diagrams)
      * [Web Applications Wire flow Diagrams](#web-applications-wire-flow-diagrams)
    ...
    * [Mobile Applications User Flow Diagrams](#mobile-applications-user-flow-diagrams)
...
* [Capítulo VI: Product Implementation, Validation & Deployment](#capítulo-vi-product-implementation-validation--deployment)
  ...
  * [6.2. Landing Page, Services & Applications Implementation](#62-landing-page-services--applications-implementation)
    ...
    * [**Sprint Backlog - Detalle de Tareas (Sprint 1)**](#sprint-backlog---detalle-de-tareas-sprint-1)
      * [6.2.1.4. Development Evidence for Sprint Review](#6214-development-evidence-for-sprint-review)
      * [WasteTrackk citizen mobile app](#wastetrackk-citizen-mobile-app)
      * [Waster Track Municipal Admin Web App](#waster-track-municipal-admin-web-app)
      * [6.2.1.5. Testing Suite Evidence for Sprint Review](#6215-testing-suite-evidence-for-sprint-review)
    * [**Pruebas Unitarias de Entidades Core**](#pruebas-unitarias-de-entidades-core)
      * [**Container Monitoring**](#container-monitoring)
      * [**Municipal Operations**](#municipal-operations)
    * [**Pruebas de Integración**](#pruebas-de-integración)
    * [**Pruebas de Comportamiento (BDD)**](#pruebas-de-comportamiento-bdd)
    * [**Pruebas de Sistema (End-to-End con Postman)**](#pruebas-de-sistema-end-to-end-con-postman)
      * [Execution Evidence for Sprint Review](#execution-evidence-for-sprint-review)
    * [Implemented Landing Page Evidence](#implemented-landing-page-evidence)
    * [Implemented Frontend-Web Application Evidence](#implemented-frontend-web-application-evidence)
      * [Imagenes de la aplicación web para administrador municipal](#imagenes-de-la-aplicación-web-para-administrador-municipal)
      * [Implemented Mobile Application Evidence](#implemented-mobile-application-evidence)
      ...
      * [Web App Municipal admin](#web-app-municipal-admin)
    ...
    * [Sprint Backlog - Detalle de Tareas (Sprint 2)](#sprint-backlog---detalle-de-tareas-sprint-2)
      * [6.2.1.4. Development Evidence for Sprint Review](#6214-development-evidence-for-sprint-review-1)
  * [**Development Evidence – Backend**](#development-evidence--backend)
    * [**Commits relevantes del Sprint 2**](#commits-relevantes-del-sprint-2)
  * [**Development Evidence – Frontend Web**](#development-evidence--frontend-web)
    * [**Commits relevantes del Sprint 2**](#commits-relevantes-del-sprint-2-1)
  * [**Development Evidence – Mobile App**](#development-evidence--mobile-app)
    * [**Commits relevantes del Sprint 2**](#commits-relevantes-del-sprint-2-2)
      * [6.2.1.5. **Testing Suite Evidence for Sprint Review – Sprint 2**](#6215-testing-suite-evidence-for-sprint-review--sprint-2)
    * [**Feature: Simulación de recolección**](#feature-simulación-de-recolección)
    * [**Feature: Gestión de contenedores**](#feature-gestión-de-contenedores)
    * [**Feature: Visualización móvil de contenedores**](#feature-visualización-móvil-de-contenedores)
    * [**Feature: Alertas por zonas críticas**](#feature-alertas-por-zonas-críticas)
    * [**Feature: Alertas por retraso de camión**](#feature-alertas-por-retraso-de-camión)
    * [**Feature: Configuración de alertas**](#feature-configuración-de-alertas)
    * [**Feature: Historial de rutas**](#feature-historial-de-rutas)
    * [**Feature: Reporte semanal**](#feature-reporte-semanal)
    * [**Feature: Residuos recolectados por tipo**](#feature-residuos-recolectados-por-tipo)
      * [6.2.2.5 Execution Evidence for Sprint Review](#6225-execution-evidence-for-sprint-review)
    * [Implemented Landing Page Evidence](#implemented-landing-page-evidence-1)
    * [Implemented Frontend-Web Application Evidence](#implemented-frontend-web-application-evidence-1)
      * [Imagenes de la aplicación web para administrador municipal](#imagenes-de-la-aplicación-web-para-administrador-municipal-1)
      * [Implemented Mobile Application Evidence](#implemented-mobile-application-evidence-1)
      * [WasteTrack Citizen mobile app](#wastetrack-citizen-mobile-app-1)
      * [6.2.1.7. Services Documentation Evidence for Sprint Review](#6217-services-documentation-evidence-for-sprint-review-1)
        * [**Tabla de Endpoints Documentados**](#tabla-de-endpoints-documentados)
        * [**Capturas de Documentación en Swagger UI**](#capturas-de-documentación-en-swagger-ui)
          * [**Vista General de Swagger UI**](#vista-general-de-swagger-ui)
          * [**Endpoints de Autenticación**](#endpoints-de-autenticación)
          * [**Endpoints de Contenedores**](#endpoints-de-contenedores)
          * [**Endpoints de Rutas y Waypoints**](#endpoints-de-rutas-y-waypoints)
        * [**Repositorio y Commits Relacionados**](#repositorio-y-commits-relacionados)
        * [**Herramientas Utilizadas**](#herramientas-utilizadas)
      * [6.2.1.9. Team Collaboration Insights during Sprint](#6219-team-collaboration-insights-during-sprint-1)
      * [Fronted insights](#fronted-insights-1)
      * [Municipality Admin Web Application](#municipality-admin-web-application-1)
      * [WasteTrack Citizen Mobile Application](#wastetrack-citizen-mobile-application-1)
      * [Backend insights](#backend-insights-1)
...
* [Anexos](#anexos)
  ...
  * [Anexo C: Video de Exposición TB1](#anexo-c-video-de-exposición-tb1)
<!-- TOC -->
...
|:----------------------------------------------------------------------------------------------------|:---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Trabaja en equipo para proporcionar liderazgo en forma conjunta.**                                | **TB1** - **Gutiérrez Soto, Jhosepmyr**: Lideró el análisis de la problemática y la formulación de los Lean UX Problem Statements, guiando al equipo en la definición inicial del proyecto.<br><br>**TP1** - **Gutiérrez Soto, Jhosepmyr**: Lideró la ejecución técnica del Sprint 1, asegurando la integración de los componentes de backend y frontend. Diseñó y desarrolló la arquitectura de seguridad (autenticación con JWT) y supervisó el despliegue de la infraestructura en Azure, configurando las bases para el pipeline de CI/CD.<br><br>**TB2** - **Gutiérrez Soto, Jhosepmyr**: Dirigió la implementación de la lógica de negocio central en el Sprint 2, liderando el diseño del `RouteOptimizationService` (US12, TS03) y el endpoint de agregación para el Dashboard de KPIs (US31).<br><br>**TB1** - **Hernández Tuiro, Eric**: Asumió el liderazgo en la, coordinando la grabación, transcripción y el análisis de los datos para obtener insights clave.<br><br>**TP1** - **Hernández Tuiro, Eric**: Asumió el desarrollo de endpoints cruciales de la API RESTful, implementando la lógica de negocio para la gestión de Distritos, Contenedores y Vehículos, asegurando la correcta persistencia de los datos.<br><br>**TB2** - **Hernández Tuiro, Eric**: Lideró la expansión de la API para soportar la nueva aplicación del Conductor, creando los endpoints protegidos (ej. `/api/v1/driver/my-route` - US13) y el servicio de confirmación de recolección (`.../confirm` - US16).<br><br>**TB1** - **Riva Rodríguez, Elmer**: Dirigió la fase de Diseño de Software, tomando decisiones cruciales sobre la arquitectura, el diseño de la base de datos y la implementación del Domain-Driven Design.<br><br>**TP1** - **Riva Rodríguez, Elmer**: Dirigió y ejecutó el desarrollo completo de la interfaz de usuario para la aplicación web de administración y la Landing Page, implementando vistas para la gestión de dispositivos y colaboradores, así como los componentes de UI reutilizables.<br><br>**TB2** - **Riva Rodríguez, Elmer**: Lideró el desarrollo de las funcionalidades de negocio clave en la web de administración (React), implementando el Dashboard de KPIs (US31) y la interfaz de "Gestión de Rutas" (US12) para el Sprint 2.<br><br>**TB1** - **Rivadeneyra Ramos, Joaquín**: Lideró la fase de Diseño de Entrevistas, creando la estructura de las preguntas para cada segmento objetivo. Además, guió al equipo en la definición de los User Personas y el User Journey Mapping.<br><br>**TP1** - **Rivadeneyra Ramos, Joaquín**: Lideró el desarrollo de la aplicación móvil para ciudadanos en Flutter, implementando el flujo de onboarding, el mapa interactivo y el reporte de incidencias. Además, colaboró en la ejecución de pruebas End-to-End con Postman.<br><br>**TB2** - **Rivadeneyra Ramos, Joaquín**: Lideró el diseño y desarrollo completo de la nueva `waste_track_driver_app` (App del Conductor), implementando el flujo de login, visualización de hoja de ruta (US13) y confirmación de paradas (US16).<br><br>**TB1** - **Rojas Ccama, Carlos**: Lideró la sección de Análisis Competitivo, identificando a los principales actores y sus estrategias. También guió la creación de los artefactos de UI/UX, asegurando un diseño coherente y funcional.<br><br>**TP1** - **Rojas Ccama, Carlos**: Desarrolló funcionalidades específicas del backend, como la lógica para las alertas de contenedores, y fue responsable de la creación y ejecución de las pruebas de comportamiento (BDD) con Cucumber, garantizando que la lógica de negocio cumpliera con los escenarios definidos.<br><br>**TB2** - **Rojas Ccama, Carlos**: Lideró la estrategia de QA para el Sprint 2, diseñando y ejecutando el plan de pruebas para la App del Conductor y los escenarios BDD para la optimización de rutas (US12), garantizando el cumplimiento del Sprint Goal. | **TB1:** El equipo demostró un liderazgo rotativo y compartido a lo largo del proyecto. Cada miembro asumió la responsabilidad de guiar una fase específica, mostrando iniciativa, experiencia y autonomía. Este enfoque de liderazgo conjunto fue fundamental para el progreso del proyecto, permitiendo que cada fase fuera completada con eficiencia y altos estándares de calidad.<br><br>**TP1:** Durante la ejecución del Sprint 1, el liderazgo conjunto fue clave para construir el 'esqueleto funcional'. El equipo operó con un modelo de 'propiedad de dominio', donde cada líder técnico (Backend, Frontend, Móvil) tomó decisiones autónomas para implementar su componente (API, Web App, App Ciudadano) y asegurar una integración técnica exitosa del E2E.<br><br>**TB2:** En el Sprint 2 (TB2), el liderazgo técnico se expandió para entregar la lógica de negocio central. El liderazgo en Backend (Jhosepmyr, Eric) y Móvil (Joaquín, Elmer) fue crucial para desarrollar el nuevo flujo del Conductor y el servicio de optimización (US12), demostrando que el modelo de liderazgo compartido escaló exitosamente de la arquitectura base a las funcionalidades complejas.                                          |
| **Crea un entorno colaborativo e inclusivo, establece metas, planifica tareas y cumple objetivos.** | **TB1** - **Gutiérrez Soto, Jhosepmyr**: Contribuyó activamente a las sesiones de EventStorming, asegurando que el flujo de eventos del sistema fuera claro para todos y que cada miembro comprendiera las interdependencias del proyecto.<br><br>**TP1** - **Gutiérrez Soto, Jhosepmyr**: Definió y gestionó los artefactos de Scrum para el Sprint 1, incluyendo el Sprint Backlog y el desglose de tareas, facilitando la planificación y el seguimiento del progreso del equipo.<br><br>**TB2** - **Gutiérrez Soto, Jhosepmyr**: Gestionó el Sprint Backlog 2, asegurando que las tareas para la optimización de rutas (US12) y la app del conductor (US13, US16) estuvieran bien definidas y alineadas con el Sprint Goal.<br><br>**TB1** - **Hernández Tuiro, Eric**: Se encargó de la coordinación logística de las entrevistas, facilitando la comunicación con los participantes y gestionando los registros, lo que garantizó la inclusión de las voces de los usuarios en la etapa de análisis.<br><br>**TP1** - **Hernández Tuiro, Eric**: Fue responsable de la implementación y prueba unitaria de varias entidades del dominio (`District`, `Container`), cumpliendo con las tareas asignadas en el Sprint Backlog y asegurando la calidad del código del backend.<br><br>**TB2** - **Hernández Tuiro, Eric**: Fue responsable de la evolución del pipeline de CI/CD en GitHub Actions, añadiendo los *jobs* de build y test para la nueva aplicación del Conductor y gestionando las migraciones de BBDD en Azure.<br><br>**TB1** - **Rivadeneyra Ramos, Joaquín**: Participó en la elaboración del Product Backlog, traduciendo los requisitos en tareas técnicas y estimando el esfuerzo, lo que permitió una planificación de tareas realista y eficiente.<br><br>**TP1** - **Rivadeneyra Ramos, Joaquín**: Colaboró en la definición de las tareas para la aplicación móvil y ejecutó su desarrollo de acuerdo con el Sprint Goal, logrando un prototipo funcional del flujo ciudadano.<br><br>**TB2** - **Rivadeneyra Ramos, Joaquín**: Cumplió con todas las tareas de desarrollo de la app del Conductor, colaborando estrechamente con el backend (Eric) para la integración de los nuevos endpoints y entregando la app 100% funcional.<br><br>**TB1** - **Rojas Ccama, Carlos**: Mantuvo una comunicación constante a través de plataformas digitales, organizando reuniones de seguimiento y asegurando que las metas semanales se revisaran y ajustaran según fuera necesario.<br><br>**TP1** - **Rojas Ccama, Carlos**: Participó activamente en la fase de pruebas, desarrollando los escenarios BDD y comunicando los resultados al equipo para validar la implementación del backend, contribuyendo al cumplimiento de los criterios de aceptación.<br><br>**TB2** - **Rojas Ccama, Carlos**: Colaboró en el desarrollo de los componentes React para el Dashboard (US31), integrando los endpoints de KPIs y asegurando que la visualización de datos fuera correcta.<br><br>**TB1** - **Riva Rodríguez, Elmer**: Colaboró en la creación de los User Stories y el Impact Mapping, asegurando que las tareas planificadas estuvieran directamente alineadas con los objetivos de negocio y las necesidades de los usuarios.<br><br>**TP1** - **Riva Rodríguez, Elmer**: Cumplió con los objetivos de desarrollo de frontend para el Sprint 1, entregando la Landing Page completa y las vistas funcionales de la aplicación de administración, y manteniendo una comunicación constante sobre el avance de la UI.<br><br>**TB2** - **Riva Rodríguez, Elmer**: Entregó las vistas clave del Sprint 2 (Dashboard y Gestión de Rutas), colaborando con Carlos en los componentes y con Jhosepmyr en la integración del servicio de optimización.                                                                                                                                                               | **TB1:** El equipo estableció una metodología de trabajo clara y transparente desde el inicio. La planificación conjunta y la distribución equitativa de las tareas aseguraron que los objetivos fueran alcanzados en los plazos establecidos. La comunicación abierta y las herramientas colaborativas permitieron crear un entorno inclusivo donde cada integrante pudo contribuir significativamente, lo que resultó en el cumplimiento exitoso de todos los hitos del proyecto.<br><br>**TP1:** El equipo demostró madurez ágil al cumplir el Sprint Goal 1 (esqueleto funcional). La planificación detallada del Sprint Backlog 1 y la ejecución de tareas interfuncionales (Backend-Frontend, Backend-Móvil) fueron excepcionales, permitiendo cumplir el 100% de los objetivos del hito.<br><br>**TB2:** Para el Sprint 2 (TB2), el equipo mantuvo la disciplina ágil para cumplir el Sprint Goal 2 (lógica de negocio). La colaboración fue intensa para integrar la nueva App del Conductor con los endpoints de optimización. La comunicación constante (evidenciada en las retrospectivas) fue clave para superar la complejidad de integrar tres aplicaciones (Admin, Ciudadano, Conductor) y cumplir los objetivos finales. |
<div style="page-break-before: always"></div>
...
**Enlace:** [https://upcedupe-my.sharepoint.com/:v:/g/personal/u202317638_upc_edu_pe/IQCN0uB3Ay_qR54P_ITeaSgpAXSwpvNU8vcj35oNud8Y5Go?nav=eyJyZWZlcnJhbEluZm8iOnsicmVmZXJyYWxBcHAiOiJTdHJlYW1XZWJBcHAiLCJyZWZlcnJhbFZpZXciOiJTaGFyZURpYWxvZy1MaW5rIiwicmVmZXJyYWxBcHBQbGF0Zm9ybSI6IldlYiIsInJlZmVycmFsTW9kZSI6InZpZXcifX0%3D&e=VTcBuF](https://upcedupe-my.sharepoint.com/:v:/g/personal/u202317638_upc_edu_pe/IQCN0uB3Ay_qR54P_ITeaSgpAXSwpvNU8vcj35oNud8Y5Go?nav=eyJyZWZlcnJhbEluZm8iOnsicmVmZXJyYWxBcHAiOiJTdHJlYW1XZWJBcHAiLCJyZWZlcnJhbFZpZXciOiJTaGFyZURpYWxvZy1MaW5rIiwicmVmZXJyYWxBcHBQbGF0Zm9ybSI6IldlYiIsInJlZmVycmFsTW9kZSI6InZpZXcifX0%3D&e=VTcBuF)
...
## Anexo C: Video de Exposición TP1

**Enlace:** [https://upcedupe-my.sharepoint.com/:v:/g/personal/u202317638_upc_edu_pe/IQDgU_nVhvgGT4rx5_MTNll7AZJTO7jTjDl0DhP3-w7vss8?nav=eyJyZWZlcnJhbEluZm8iOnsicmVmZXJyYWxBcHAiOiJTdHJlYW1XZWJBcHAiLCJyZWZlcnJhbFZpZXciOiJTaGFyZURpYWxvZy1MaW5rIiwicmVmZXJyYWxBcHBQbGF0Zm9ybSI6IldlYiIsInJlZmVycmFsTW9kZSI6InZpZXcifX0%3D&e=gVW2jf](https://upcedupe-my.sharepoint.com/:v:/g/personal/u202317638_upc_edu_pe/IQDgU_nVhvgGT4rx5_MTNll7AZJTO7jTjDl0DhP3-w7vss8?nav=eyJyZWZlcnJhbEluZm8iOnsicmVmZXJyYWxBcHAiOiJTdHJlYW1XZWJBcHAiLCJyZWZlcnJhbFZpZXciOiJTaGFyZURpYWxvZy1MaW5rIiwicmVmZXJyYWxBcHBQbGF0Zm9ybSI6IldlYiIsInJlZmVycmFsTW9kZSI6InZpZXcifX0%3D&e=gVW2jf)

**Descripción:** Registro audiovisual de la exposición del **Trabajo Práctico 1 (TP1)**, en el cual se presentan los avances, desarrollos y validaciones del proyecto.

**Acceso:** Enlace público de solo lectura


## Anexo D: Video de About The Team

**Enlace:** [https://upcedupe-my.sharepoint.com/:v:/g/personal/u202317638_upc_edu_pe/IQAcgB6Ukaa6R4fWv32mnbAYAeAa35iRbdbVVLJuP9emu-g?nav=eyJyZWZlcnJhbEluZm8iOnsicmVmZXJyYWxBcHAiOiJTdHJlYW1XZWJBcHAiLCJyZWZlcnJhbFZpZXciOiJTaGFyZURpYWxvZy1MaW5rIiwicmVmZXJyYWxBcHBQbGF0Zm9ybSI6IldlYiIsInJlZmVycmFsTW9kZSI6InZpZXcifX0%3D&e=h1pMb8](https://upcedupe-my.sharepoint.com/:v:/g/personal/u202317638_upc_edu_pe/IQAcgB6Ukaa6R4fWv32mnbAYAeAa35iRbdbVVLJuP9emu-g?nav=eyJyZWZlcnJhbEluZm8iOnsicmVmZXJyYWxBcHAiOiJTdHJlYW1XZWJBcHAiLCJyZWZlcnJhbFZpZXciOiJTaGFyZURpYWxvZy1MaW5rIiwicmVmZXJyYWxBcHBQbGF0Zm9ybSI6IldlYiIsInJlZmVycmFsTW9kZSI6InZpZXcifX0%3D&e=h1pMb8)

**Descripción:** Video introductorio del equipo EcoLutions, presentando a cada integrante, sus roles y contribuciones al proyecto WasteTrack.

**Acceso:** Enlace público de solo lectura

## Anexo C: Video de Exposición TB2

**Enlace:** [https://upcedupe-my.sharepoint.com/:v:/g/personal/u202317638_upc_edu_pe/IQBHBvx5pam5QK0YekxEkvgYAS4HYRn2-gdxdt-2L5a3sm4?nav=eyJyZWZlcnJhbEluZm8iOnsicmVmZXJyYWxBcHAiOiJTdHJlYW1XZWJBcHAiLCJyZWZlcnJhbFZpZXciOiJTaGFyZURpYWxvZy1MaW5rIiwicmVmZXJyYWxBcHBQbGF0Zm9ybSI6IldlYiIsInJlZmVycmFsTW9kZSI6InZpZXcifX0%3D&e=b0g8lp](https://upcedupe-my.sharepoint.com/:v:/g/personal/u202317638_upc_edu_pe/IQBHBvx5pam5QK0YekxEkvgYAS4HYRn2-gdxdt-2L5a3sm4?nav=eyJyZWZlcnJhbEluZm8iOnsicmVmZXJyYWxBcHAiOiJTdHJlYW1XZWJBcHAiLCJyZWZlcnJhbFZpZXciOiJTaGFyZURpYWxvZy1MaW5rIiwicmVmZXJyYWxBcHBQbGF0Zm9ybSI6IldlYiIsInJlZmVycmFsTW9kZSI6InZpZXcifX0%3D&e=b0g8lp)

**Descripción:** Registro audiovisual de la exposición del **Trabajo Base 2 (TB2)**, en el cual se presentan los avances, desarrollos y validaciones del proyecto.

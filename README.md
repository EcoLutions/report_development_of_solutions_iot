...
|:--------|:-----------|:------------------------------------------------|:------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| v3.2.0  | 16/11/2025 | Eric Hernández                                  | Adición de los criterios finales del Student Outcome ABET para el Sprint 2. Cierre del informe TB2.                                                                                             |
| v3.1.0  | 15/11/2025 | Jhosepmyr Gutiérrez, Eric Hernández             | Adición de la documentación de API (Swagger) para los endpoints del Sprint 2. Incorporación del video del producto y evidencias finales de despliegue móvil y validación.                       |
| v3.0.0  | 15/11/2025 | Eric Hernández, Joaquin Rivadeneyra             | Definición de artefactos (Planning, Leaders, Backlog). Creación de la sección de Validación (Diseño de Entrevistas y Evaluación Heurística). Adición de evidencias de desarrollo del Sprint 2.  |
| v2.1.0  | 09/10/2025 | Jhosepmyr, Eric, Andrés, Elmer, Joaquin, Carlos | Integración de la suite completa de pruebas (Unit, Integration, BDD, E2E con Postman). Consolidación y redacción de la sección de evidencia de pruebas para el informe del Sprint Review (TP1). |
| v2.0.0  | 06/10/2025 | Elmer, Joaquin, Jhosepmyr                       | Desarrollo de interfaces para la App Web de Admin (Gestión de Dispositivos/Colaboradores) y la App Móvil (Onboarding/Mapa). Despliegue de infraestructura en Azure y configuración de Docker.   |
...
| v1.7.0  | 20/09/2025 | Jhosepmyr, Eric, Andrés, Elmer                  | Agregado context mapping, nuevos Bounded Contexts, sección de entrevistas, arquitectura DDD y Student Outcome (TB1).                                                                            |
...
| v1.1.0  | 09/09/2025 | Jhosepmyr, Joaquin                              | Estructura base del repositorio, portada y archivos iniciales.                                                                                                                                  |
